...
public class CustomerProductController {
    ...
    public ResponseEntity<ProductDetailDto> getProductDetailedById(@PathVariable Long productId){
        ProductDetailDto productDetailDto = customerProductService.getProductDetailedById(productId);
